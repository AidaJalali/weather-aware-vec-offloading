...
def main() -> None:
    ...
    parser.add_argument(
        "--vehicles", default=str(_DEFAULT_DATA / "vehicles" / "chunk_0.xml"))
    parser.add_argument(
        "--tasks", default=str(_DEFAULT_DATA / "tasks" / "chunk_0.xml"))
    parser.add_argument(
        "--output", default=str(_DEFAULT_DATA / "results" / "random_baseline_results.csv"))
