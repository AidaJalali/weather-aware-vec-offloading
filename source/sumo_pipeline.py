...
class SumoPipelineConfig:
    ...
    chunk_size: int = 3600
    output_dir: Path = Path("source/data/sumo")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--weather-schedule", default="source/data/weather_scenarios.csv")
    parser.add_argument("--output-dir", default="source/data/sumo")
